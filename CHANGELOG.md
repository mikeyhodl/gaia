...
- Bump golang from 1.25 to 1.26 ([#4126](https://github.com/cosmos/gaia/pull/4126))
...
- Bump image-size from 1.2.1 to 2.0.4 ([#451](https://github.com/mikeyhodl/gaia/pull/451))
- Bump @docusaurus/core from 3.7.0 to 3.10.2 ([#451](https://github.com/mikeyhodl/gaia/pull/451))
- Bump @docusaurus/plugin-client-redirects from 3.7.0 to 3.10.2 ([#451](https://github.com/mikeyhodl/gaia/pull/451))
- Bump @docusaurus/plugin-google-analytics from 3.7.0 to 3.10.2 ([#451](https://github.com/mikeyhodl/gaia/pull/451))
- Bump @docusaurus/plugin-google-gtag from 3.7.0 to 3.10.2 ([#451](https://github.com/mikeyhodl/gaia/pull/451))
