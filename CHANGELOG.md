...
- Bump body-parser from 1.20.3 to 1.20.6 ([#404](https://github.com/mikeyhodl/gaia/pull/404))
- Bump express from 4.21.2 to 4.22.2 ([#404](https://github.com/mikeyhodl/gaia/pull/404))
